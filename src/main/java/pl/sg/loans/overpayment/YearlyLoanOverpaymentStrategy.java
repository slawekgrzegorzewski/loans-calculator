...
public class YearlyLoanOverpaymentStrategy implements LoanOverpaymentStrategy {
    private final BigDecimal overpaymentYearlyBudget;
    private final BigDecimal overpaymentMonthlyBudget;

    public YearlyLoanOverpaymentStrategy(BigDecimal overpaymentYearlyBudget, BigDecimal overpaymentMonthlyBudget) {
